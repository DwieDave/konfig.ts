---
title: Compile-time catches
description: The seven intentionally broken files in examples/full-stack/infra/envs, what each one gets wrong, why the type checker rejects it, and how to fix it.
sidebar:
  order: 3
---

---
title: Helm
description: Helm.release pulls a chart by version, verifies its SHA-256 digest, templates it, and hands the output to the renderer as parsed documents (ParsedDoc); the CLI adds cache pre-fetch and CRD codegen.
sidebar:
  order: 5
---

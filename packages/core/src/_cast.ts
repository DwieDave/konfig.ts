...
// is sound — audited by grepping `unsafeCoerce[<(]` (matches both the bare `unsafeCoerce(`
// and the explicit `unsafeCoerce<T>(` form). For trust-boundary values, prefer `boundary`.

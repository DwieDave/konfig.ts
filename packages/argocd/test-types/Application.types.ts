...
type _Extra_Out = Expect<
	Equal<
		typeof withExtra extends ApplicationHandle<"self-discharged", infer O, infer _I>
			? O
			: never,
...
type _Extra_In = Expect<
	Equal<
		typeof withExtra extends ApplicationHandle<"self-discharged", infer _O, infer I>
			? I
			: never,
		Dep.Need<"Secret", "x">
	>
...
type HandleEffectChannel = typeof handle extends Effect.Effect<infer A, infer _E, infer _R>
	? A
	: never;

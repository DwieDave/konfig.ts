import { decodeImagesSync, ImagesAppMissing, ImagesEnvMissing, imagesFor, requireImage } from "@konfig.ts/core"
...
const program = Effect.gen(function*() {
  ...
  yield* Effect.try({
    ...
    catch: (e) => e instanceof ImagesAppMissing ? e : new ImagesAppMissing({ env: "staging", app: "api" })
